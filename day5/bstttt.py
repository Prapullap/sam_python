...
class Bst:
    ...
    def delete_node(self):
        ...
        if temp1.left is None and temp1.right is None:  # Node to be deleted is a leaf node
            if temp2 is None:
                self.root = None
                ...
                temp2.right = None
        elif temp1.left is not None and temp1.right is not None:  # Node to be deleted has two children
            temp3 = temp1.right
            temp3_parent = temp1
            ...
            if temp3_parent.left is temp3:
                temp3_parent.left = temp3.right
            else:
                temp3_parent.right = temp3.right
        else:  # Node to be deleted has one child
            link = temp1.left if temp1.left else temp1.right
            if temp2 is None:
                self.root = link
            elif temp2.left is temp1:
                temp2.left = link
