...
def generate_certificate(data, output_dir):
    ...
    background_image_base64 = encode_image_to_base64(r"C:\Learning\python\sam_python\Certificate_Generator(White)\assests\background.png")
    org_logo_base64 = encode_image_to_base64(r"C:\Learning\python\sam_python\Certificate_Generator(White)\assests\logo.png")
    signature_image_base64 = encode_image_to_base64(r"C:\Learning\python\sam_python\Certificate_Generator(White)\assests\sign.png")
...
if __name__ == "__main__":
    input_csv = r"C:\Learning\python\sam_python\Certificate_Generator(White)\assests\data.csv"  # Path to CSV file
    output_directory = r"C:\Learning\python\sam_python\Certificate_Generator(White)\html_certificates"  # Output directory
